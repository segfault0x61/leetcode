...
namespace LeetCode.Test._0001_0050
{
    ...
    {
        [TestMethod]
        public void RomanToInt_LessThan10_ReturnsCorrespondingInteger()
        {
        ...
        [TestMethod]
        public void RomanToInt_LessThan100_ReturnsCorrespondingInteger()
        {
            var solution = new _013_RomanToInteger();
        ...
        [TestMethod]
        public void RomanToInt_LessThan1000_ReturnsCorrespondingInteger()
        {
            var solution = new _013_RomanToInteger();
        ...
        [TestMethod]
        public void RomanToInt_LessThan4000_ReturnsCorrespondingInteger()
        {
            var solution = new _013_RomanToInteger();
